            ...
            if (!message.JSONConversionFailed)
            {
                ...
                if (message.id.Contains(id_to_parse) == true)
                {
                    ...
                    if(temp_value >= 0.0) // j'achète
                    {
                        ...
                        {
                            if ((DateTime.Now.TimeOfDay - old_time_buy).Minutes > time_wait_min_buy || flag_buy_cheap == false)
                            {
                        ...
                        {
                            if((DateTime.Now.TimeOfDay - old_time_buy).Minutes > time_wait_min_buy || flag_buy_expen == false)
                            {
                                old_time_buy = DateTime.Now.TimeOfDay;
                                flag_buy_expen = true;
                    ...
                    else // je vends
                    {
                        ...
                        {
                            if ((DateTime.Now.TimeOfDay - old_time_sell).Minutes > time_wait_min_sell || flag_sell_cheap == false)
                            {
                        ...
                        {
                            if((DateTime.Now.TimeOfDay - old_time_sell).Minutes > time_wait_min_sell || flag_sell_expen == false)
                            {
                                old_time_sell = DateTime.Now.TimeOfDay;
