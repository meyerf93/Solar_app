            ...
            if (!message.JSONConversionFailed)
            {
                ...
                if(right_message)
                {
                    ...
                    if (value_prod == value_conso)
                    {
                        ...
                        {
                            if ((DateTime.Now.TimeOfDay - old_time_conso_more).Seconds > time_wait_conso_more || flag_conso_more == false)
                            {
                        ...
                        {
                            if ((DateTime.Now.TimeOfDay - old_time_prod_less).Seconds > time_wait_prod_less || flag_prod_less == false)
                            {
                    ...
                    {
                        if ((DateTime.Now.TimeOfDay - old_time_prod_more).Seconds > time_wait_prod_more || flag_prod_more == false)
                        {
                    ...
                    {
                        if ((DateTime.Now.TimeOfDay - old_time_conso_less).Seconds > time_wait_conso_less || flag_conso_less == false)
                        {
